                    ...
                    <nav class="main-menu navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="menucontent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link" href="staff.php">Medical Staff</a></li>
                                <!-- <li class="nav-item dropdown">
...
<div class="carousel slide" id="featured" data-ride="carousel">
    ...
    <div style="max-height: 470px;" class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block img-fluid" src="assets/images/5.jpg" alt="Medical Center">
            <div class="carousel-caption d-none d-md-block">
            <h1>Medical Center of NTU</h1>
            </div>
        </div>
         <div class="carousel-item">
            <img class="d-block img-fluid" src="assets/images/6.jpg" alt="Medical Center">
        </div>    
        <div class="carousel-item">
             <img class="d-block img-fluid" src="assets/images/9.jpg" alt="Medical Center">
        </div>
        <div class="carousel-item">
             <img class="d-block img-fluid" src="assets/images/8.jpg" alt="Medical Center">
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="scholership-promo-text">
                    <h2> <span>Healthcare</span> For all Students and Employees!</h2>
                    ...
                    <a href="MSN-employee/register_form.php" class="btn btn-brand">Apply Now</a>
                </div>
            </div>
        </div>
    </div>
